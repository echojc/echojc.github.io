...
{{< img src="images/tunic/lost-see.png" >}}
...
{{< img src="images/tunic/controls.png" caption="Aside: I think I got slightly lucky here, because I only noticed later that the final character here is NOT the same glpyh as the S - it's flipped because it's actually a Z." >}}
...
{{< img src="images/tunic/shield.png" >}}
...
{{< img src="images/tunic/roll-run.png" >}}
...
{{< img src="images/tunic/comparison.png" caption="Note: some of these transcriptions aren't correct and still needed refinement, but they were what I had to work with at this stage." >}}
...
have the same pronunciation are spelt the same in the game:
...
In fact, it was this clue they motivated me to try to decipher the script,
since it implied that there was something more to it than just flavour.

Without the dot, this speech bubble would have read **MY STUCK**, which doesn't
make sense:


{{< img src="images/tunic/my-stuck.png" >}}
...
{{< img src="images/tunic/im-stuck.png" >}}
...
{{< img src="images/tunic/the-thee-runes.png" >}}

which you can see in sentences like this one:

{{< img src="images/tunic/the-thee.png" caption="Inscription reads: THEE (/ði:/) heir hungers for reminders of THE (/ðə/) corporeal world." >}}
...
Personally, as a Kiwi English speaker, I'd always prefer the KIT vowel (such as
the choice of spelling for the ["nek minnit"
...
{{< img src="images/tunic/button.png" >}}
...
{{< img src="images/tunic/title.png" >}}
